...
class MRSession:
    ...
    def executeQuery(self):
        ...
        cmd = 'hadoop jar {hadoop_streaming_jar} -file {mapper_path} -mapper {mapper_path} -file ' \
              '{reducer_path} -reducer {reducer_path} -input {input_dir}/{table}.csv -output {output_dir}'.format(
